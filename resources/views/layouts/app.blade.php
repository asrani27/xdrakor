  ...
  <div class="wrapper">
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
      ...
      <a href="#" class="brand-link">
        <img src="/muvnix/dist/img/AdminLTELogo.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3"
          style="opacity: .8">
    ...
    <footer class="main-footer">
      ...
      <div class="float-right d-none d-sm-inline">
        ...
        <a href="/" alt="page hit counter" target="_blank">
          <embed src="//s10.histats.com/110.swf" flashvars="jver=1&acsid=3995498&domi=4" quality="high" width="145"
            height="23" name="110.swf" align="middle" type="application/x-shockwave-flash"
            pluginspage="//www.macromedia.com/go/getflashplayer" wmode="transparent" /></a>
